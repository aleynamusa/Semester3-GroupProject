  ...
  return (
    <form onSubmit={submit} className={`relative ${className}`}>
      <input
        ...
        className="w-64 md:w-80 rounded-full border border-neutral-400 bg-white px-4 py-2 pr-20 text-sm text-neutral-900 placeholder:text-neutral-500 focus:outline-none focus:ring-2 focus:ring-neutral-500"
      />
