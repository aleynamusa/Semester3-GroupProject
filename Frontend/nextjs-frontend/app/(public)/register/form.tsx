    ...
    return (
        <form onSubmit={onSubmit} className="space-y-2">
            <div className="grid w-fullmax-w-sm items-center gap-1.5">
                ...
                <input id="username" name="username" type="text" className="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-[#00A527] sm:text-sm/6" value={username} onChange={e => setUsername(e.target.value)} />
            </div>
            ...
            <div className="w-full">
                <button type="submit" className="mt-8 w-full bg-[#00A527] font-semibold text-white rounded-lg px-4 py-2 hover:bg-[#00A527]/80">{loading? "Creating..." : "Register"}</button>
            </div>
        </form>
